...
/*
 * BD_Agenda: Operaciones de inserción, borrado y búsqueda en la tabla contactos
 */
package bbdd;
...
public class BD_Agenda extends BD_Conector {
	...
	public  boolean añadir(Contacto ct){
		String cadena="INSERT INTO contactos VALUES('" + ct.getNombre() + "','" + ct.getApellidos()+"','"+ ct.getTelefono() +"')"; 	
